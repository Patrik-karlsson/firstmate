...
A live option presentation left beside a recorded answer reads as a fresh question and invites a contradictory second answer, so an answered decision must never remain presentable as open.
